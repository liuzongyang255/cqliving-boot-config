package com.leo.boot.config.conf;
...
import cqliving.framework.cloud.core.utils.DateUtils;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configureMessageConverters(List<HttpMessageConverter<?>> converters) {
        ...
        */
        ...
        config.setDateFormat(DateUtils.DEFAULT_DATE_FORMAT_STRING);
